...
# - graph_membros: retorna grafo (nós/arestas) via Supabase RPC (fallback c/ e s/ p_)
# - vis_visjs: página HTML com vis-network (JS externo /static/vis-embed.js)
...
# -----------------------------------------------------------------------------
# VIS.JS (vis-network) — usa JS externo /static/vis-embed.js (sem f-strings no JS)
# -----------------------------------------------------------------------------
...
async def vis_visjs(
    ...
    html = (
        ...
        "    <script>(function(){ if(window.KGVis && KGVis.autorun){ KGVis.autorun(); }})();</script>\n"
        "  </body>\n"
        "</html>\n"
    )
...
# # - Utilidades: normalização de labels PG array, cache Redis, truncamento seguro
# # Atualização: 08/09/2025 as 10h27min
# # =============================================================================
