...
(function () {
  ...
  // 🔒 Guard: se a página foi gerada em modo "server", não executa o loader client
  const sourceAttr = (container.getAttribute('data-source') || '').toLowerCase();
  if (sourceAttr === 'server') return;
