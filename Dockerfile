...
# Arquivo: Dockerfile
# Versão: v1.7.20
# Objetivo: Build da imagem svc-kg (Python 3.11 + FastAPI + vis-network) — INALTERADO
# Funções/métodos:
# - Instala deps, copia código/estáticos, baixa vis-network, executa uvicorn/gunicorn
# =============================================================================
